...
#define PRTCL_DEVTYPE_MONITORSCREEN 0x0F
...
#define NOISE_DETECTIVE_SWITCH              0x0407
#define NOISE_DETECTIVE_SWITCH_RE           0x0408
...
int ProtocolSndNoiseSensorPack(u8 *pbuf, int *plen, u8 NoiseSensorState);
