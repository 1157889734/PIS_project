...
{
	"本设备为客室LED显示屏，用于显示预到站、到站信息以及紧急广播信息，设备运行正常!",
	"本设备为客室LED显示屏，设备无应用程序，当前运行的是设备的bootloader, 请下载正确的应用程序!!",
	"\0",
};
...
void fill_run_info(unsigned char *buf)
{
	...
	sprintf((char *)buf, FMT_run_info, DevType, DevId, sw_version, build_date, dev_description[1]);
